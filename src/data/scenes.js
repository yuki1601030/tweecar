...
export const scenes = [
  {
    id: 'sceneA1', situation: '状況A', sceneNo: 1, image: '/assets/scenes/sceneA1.jpg', title: '通常走行 / 背後で危険の兆候',
  ...
  {
    id: 'sceneA2', situation: '状況A', sceneNo: 2, image: '/assets/scenes/sceneA2.jpg', title: '高速接近 / A車の近くにアラート',
  ...
  {
    id: 'sceneA3', situation: '状況A', sceneNo: 3, image: '/assets/scenes/sceneA3.jpg', title: 'AI音声で退避を促す', voiceRequired: true,
  ...
  {
    id: 'sceneA4', situation: '状況A', sceneNo: 4, image: '/assets/scenes/sceneA4.jpg', title: 'B車が通過 / 事前回避で安全確保',
  ...
  {
    id: 'sceneB5', situation: '状況B', sceneNo: 5, image: '/assets/scenes/sceneB5.jpg', title: 'F車のながら運転リスクを裏側で検知',
  ...
  {
    id: 'sceneB6', situation: '状況B', sceneNo: 6, image: '/assets/scenes/sceneB6.jpg', title: 'F車の危険度が上昇',
  ...
  {
    id: 'sceneB7', situation: '状況B', sceneNo: 7, image: '/assets/scenes/sceneB7.jpg', title: 'AI音声で安全距離を促す', voiceRequired: true,
  ...
  {
    id: 'sceneB8', situation: '状況B', sceneNo: 8, image: '/assets/scenes/sceneB8.jpg', title: '危険回避完了 / 快適に走行継続',
